...
def create_zip(
    patchwise_thresholded_tissue_nontissue: np.ndarray, uploaded_file: st.uploaded_file_manager.UploadedFile
):
    save_files_no_decorator.create_zip(patchwise_thresholded_tissue_nontissue, uploaded_file)
